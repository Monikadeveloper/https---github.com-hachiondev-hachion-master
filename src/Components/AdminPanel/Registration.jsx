...
const registerlist = [
    createData(1, 'Priti Visara','Pritivisa@gmail.com','201918555','United States','Massachusettes','Mansfield'),
...
const studentdetails = [
    ...
    createData(2, 'Mita Shah','rakanmit2000@yahoo.com','6157011665','Bangladesh',null,null,'12-5-2023','PDT','In-active' ),
    createData(3,  'Manhar','Manhartejraj@gmail.com','6178098765', 'India',null,null,'01-04-2021','CST','Active'),

];

export default function Registration() {
  const [activeTab, setActiveTab] = useState('registerlist'); // Default tab is Course Certificate
